...
public class CreateTessere {
    ...
    public List<Tessera> createTessera(TesseraDao tesseraDao, List<Utente> utenti) {
        if (tesseraDao.count() == 0) {
            ...
            Tessera tessera2 = new Tessera(LocalDate.of(2024, 6, 18), utenti.get(0));
            Tessera tessera3 = new Tessera(LocalDate.of(2025, 5, 3), utenti.get(0));
            Tessera tessera4 = new Tessera(LocalDate.of(2025, 8, 19), utenti.get(0));
            Tessera tessera5 = new Tessera(LocalDate.of(2025, 11, 12), utenti.get(0));
            Tessera tessera6 = new Tessera(LocalDate.of(2026, 1, 5), utenti.get(0));
            Tessera tessera7 = new Tessera(LocalDate.of(2026, 3, 30), utenti.get(0));
            Tessera tessera8 = new Tessera(LocalDate.of(2026, 5, 14), utenti.get(0));
            Tessera tessera9 = new Tessera(LocalDate.of(2026, 6, 22), utenti.get(0));
            Tessera tessera10 = new Tessera(LocalDate.of(2025, 2, 15), utenti.get(0));
